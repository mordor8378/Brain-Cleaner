...
export default function EditProfile() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updateData = {
        ...
        birthDate: userInfo.birthDate ? userInfo.birthDate.toISOString().split('T')[0] : null,
      ...
      const response = await fetch(`http://localhost:8090/api/v1/users/${userInfo.id}`, {
        method: 'PUT',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8090/api/v1/users/${userInfo.id}/password`, {
        method: 'PUT',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      // 계정 삭제 요청
      const deleteResponse = await fetch(`http://localhost:8090/api/v1/users/${userInfo.id}`, {
        method: 'DELETE',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
      ...
      if (deleteResponse.ok) {
        // 로그아웃 요청
        const logoutResponse = await fetch('http://localhost:8090/api/v1/users/logout', {
          method: 'POST',
          credentials: 'include',
          headers: {
            'Content-Type': 'application/json',
    ...
    <div className="max-w-2xl mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <section>
          ...
          <div className="flex flex-col items-center mb-6">
            <div className="relative w-24 h-24 mb-4">
              ...
              />
              <label htmlFor="profile-image" className="absolute bottom-0 right-0 bg-pink-500 text-white p-2 rounded-full cursor-pointer hover:bg-pink-600 transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="statusMessage" className="block text-sm font-medium text-gray-700 mb-1">상태 메시지</label>
              <textarea
                id="statusMessage"
                name="statusMessage"
            ...
            <div>
              ...
              <DatePicker
                ...
                onChange={(date: Date | null) => setUserInfo(prev => ({ ...prev, birthDate: date }))}
        ...
        <section>
          ...
          <div>
            <label htmlFor="detoxGoal" className="block text-sm font-medium text-gray-700 mb-1">도파민 디톡스 목표</label>
            <textarea
              id="detoxGoal"
              name="detoxGoal"
        ...
        <section>
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="private-profile" className="ml-2 text-sm text-gray-700">
              전체 공개
            </label>
          </div>
        </section>
        ...
        <div className="flex justify-end gap-4 pt-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`px-4 py-2 text-white bg-pink-500 rounded-md hover:bg-pink-600 transition-colors ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
